    ...
    return (
        <div className="relative flex min-h-screen w-full flex-col bg-[#111921] text-white overflow-x-hidden">
            ...
            <div className="layout-container relative z-10 flex h-full grow flex-col">
                {/* Top Navigation Bar */}
                <header className="flex items-center justify-between whitespace-nowrap border-b border-solid border-white/10 px-6 lg:px-10 py-4">
                    <Link href="/" className="flex items-center gap-4 text-white">
                        ...
                        <h2 className="text-white text-xl font-bold leading-tight tracking-tight">POS Admin</h2>
                    </Link>
                    <div className="flex items-center gap-4">
                        <span className="hidden sm:inline text-sm text-slate-400">Need help?</span>
                        <button className="flex min-w-[84px] cursor-pointer items-center justify-center overflow-hidden rounded-xl h-10 px-4 bg-[#308ce8] text-white text-sm font-bold leading-normal tracking-[0.015em] hover:bg-[#308ce8]/90 transition-colors">
