    ...
    return (
        <LandingLayout>
            <main className="flex flex-1 justify-center py-20 relative overflow-hidden bg-white text-slate-900">
                ...
                <div className="layout-content-container flex flex-col max-w-[960px] flex-1 px-4 relative z-10">
                    <div className="flex flex-col items-center justify-center py-8">
                        <div className="relative flex items-center justify-center">
                            <motion.div
                                ...
                                className="absolute inset-0 bg-red-500/10 blur-[60px] rounded-full"
                            />
                            <motion.div
                                initial={{ opacity: 0, scale: 0.8, rotate: -20 }}
                                animate={{ opacity: 1, scale: 1, rotate: 0 }}
                                transition={{ type: "spring", damping: 12 }}
                                className="relative bg-red-50 border border-red-200/80 p-8 rounded-full shadow-[0_8px_40px_rgba(239,68,68,0.15)]"
                            >
                                <XCircle className="w-[120px] h-[120px] text-red-500 stroke-[1.5]" />
                            </motion.div>
                        </div>
                    </div>
                    ...
                    <div className="text-center mt-8">
                        ...
                        <motion.p
                            ...
                            className="text-slate-500 text-lg md:text-xl font-normal leading-relaxed pb-8 pt-1 px-4 max-w-2xl mx-auto"
                        >
                            Maaf, transaksi Anda tidak dapat diproses. Silakan periksa kembali detail pembayaran Anda atau coba gunakan metode pembayaran lain.
                        </motion.p>
                    </div>
                        ...
                        <div className="w-full max-w-[480px] flex flex-col md:flex-row items-stretch rounded-2xl shadow-lg bg-white border border-slate-200 overflow-hidden group">
                            ...
                            <div className="w-full md:w-[160px] relative shrink-0">
                                ...
                                <div className="w-full h-full min-h-[140px] flex items-center justify-center p-6 text-white relative z-10">
                                    <div className="p-4 bg-white/20 rounded-2xl backdrop-blur-xl border border-white/30 shadow-2xl skew-x-3 rotate-3">
                            ...
                            <div className="flex w-full grow flex-col items-stretch justify-center gap-3 py-5 px-6 bg-white">
                                ...
                                <div className="flex flex-col gap-0.5 mt-1">
                                    ...
                                    <p className="text-slate-400 text-xs font-medium leading-normal mt-1.5 flex items-center gap-1.5">
                                        ...
                                        Metode pembayaran gagal diverifikasi
                                    </p>
                                </div>
                            </div>
                        </div>
                    ...
                    >
                        ...
                        <Link
                            href="/"
                            className="flex min-w-[240px] cursor-pointer items-center justify-center rounded-2xl h-14 px-8 border-2 border-slate-200 text-slate-700 hover:text-slate-900 hover:bg-slate-50 text-lg font-bold transition-all active:scale-[0.98]"
                        >
                            Kembali ke Beranda
                        </Link>
                    </motion.div>
                ...
                <div className="fixed top-1/4 -left-20 w-[500px] h-[500px] bg-red-500/5 rounded-full blur-[120px] pointer-events-none -z-10" />
                <div className="fixed bottom-1/4 -right-20 w-[500px] h-[500px] bg-red-500/5 rounded-full blur-[120px] pointer-events-none -z-10" />
            </main>
        </LandingLayout>
    );
};
