...
export const ResetPasswordMobile: React.FC<ResetPasswordMobileProps> = ({
    email,
    otp,
    isLoading,
    error,
    ...
    return (
        <AuthLayout
            title="Atur Ulang"
            subtitle="Buat kata sandi baru akun Anda"
            icon={<Lock className="w-8 h-8" />}
        >
            <form onSubmit={formik.handleSubmit} className="flex flex-col gap-4 px-2">
                {/* New Password */}
                <div className="flex flex-col gap-2.5">
                    <label className="text-slate-700 text-sm font-semibold leading-normal">Kata Sandi Baru</label>
                    <div className="relative group">
                        <Lock className="absolute left-4 top-1/2 -translate-y-1/2 text-slate-400 text-lg" />
                        <input
                            name="password"
                            type="password"
                            placeholder="••••••••"
                            ...
                            } bg-slate-50 focus:bg-white focus:border-primary h-12 pl-11 pr-4 text-base font-normal leading-normal transition-all`}
                ...
                {/* Confirm Password */}
                <div className="flex flex-col gap-2.5">
                    <label className="text-slate-700 text-sm font-semibold leading-normal">Konfirmasi Kata Sandi</label>
                    <div className="relative group">
                        <CheckCircle className="absolute left-4 top-1/2 -translate-y-1/2 text-slate-400 text-lg" />
                        <input
                ...
                <button
                    ...
                    className="flex w-full cursor-pointer items-center justify-center rounded-xl h-12 px-5 btn-green text-white text-base font-bold shadow-md disabled:opacity-50 mt-2"
                >
                    {isLoading ? (
